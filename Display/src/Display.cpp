...
int Display::ssd1306_i2c_display_initialize(ssd1306_i2c_t *oled)
{
  int rc = 0;
  uint8_t data;
  if (!oled || oled->fd < 0)
...
int Display::ssd1306_i2c_run_cmd(ssd1306_i2c_t *oled, ssd1306_i2c_cmd_t cmd, uint8_t *data, size_t dlen)
{
  if (!oled || oled->fd < 0)
  {
    printf("ERROR: Invalid ssd1306 I2C object\n");
...
int Display::ssd1306_i2c_display_clear(ssd1306_i2c_t *oled)
{
